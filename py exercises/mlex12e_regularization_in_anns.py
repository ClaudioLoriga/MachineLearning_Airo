# -*- coding: utf-8 -*-
"""MLEx12e.Regularization_in_ANNs

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1E5fdpc84ysiLT4Yc2mMn_48EB5igeqbY

# Machine Learning Exercise

# 12e. Regularization in ANNs
...
Note:  
loss `categorical_crossentropy` is used when classes in data set encoded with one_hot representation

loss `sparse_categorical_crossentropy` is used when classes in data set encoded with integer numbers
"""

nepochs = 50
batch_size = 64
optimizer_name = "RMSprop" # choose between adam, RMSprop, sgd
