# -*- coding: utf-8 -*-
"""MLEx3b.SPAM_classification

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18pD-uvjr6wPG8amj_hL9VhBvyoBeFuKF

# Machine Learning Exercise
# 3b. SMS SPAM classification
...
vectorizer_type = "count" # "binary", "count" or "tfidf"

if vectorizer_type == "binary":
  vectorizer = CountVectorizer(binary=True,stop_words='english') # multivariate
elif vectorizer_type == "count":
  vectorizer = CountVectorizer(binary=False,stop_words='english') # multinomial
...
[BernoulliNB](https://scikit-learn.org/stable/modules/generated/sklearn.naive_bayes.BernoulliNB.html) designed for binary features.


[MultinomialNB](https://scikit-learn.org/stable/modules/generated/sklearn.naive_bayes.MultinomialNB.html) designed for discrete features, works also with tf-idf.
"""
