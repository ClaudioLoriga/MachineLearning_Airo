# -*- coding: utf-8 -*-
"""MLEx6a.Generative_Discriminative

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UT1mRZEkw337mhs1VGoRpEHIqyFbHpCs

# Machine Learning Exercise
# 6a. Generative - Discriminative Classifiers
...
def plot_ellipse(ax, mu, sigma, color="k", label=None):
    ...
    ellipse = Ellipse(mu, w, h, angle=theta, color=color, label=label)
